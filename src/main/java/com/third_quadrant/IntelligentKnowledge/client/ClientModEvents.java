...
import com.third_quadrant.intelligentknowledge.client.gui.KnowledgeBookScreen;
...
// 클라이언트 전용: 등록한 메뉴 타입에 맞는 화면을 연결한다.
...
public class ClientModEvents {
    ...
    public static void onRegisterMenuScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModMenus.KNOWLEDGE_BOOK.get(), KnowledgeBookScreen::new);
    }
}
